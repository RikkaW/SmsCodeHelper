miui_MI3WMI4W_5.12.4_1836e1cc3c_4.4
====
`2015-12-26`

[ 【2015年12月18日】小米手机第214周更新公告发布](http://bbs.xiaomi.cn/t-11893775)

## Mms(短信)

![icon](./res/mipmap-xhdpi-v4/ic_launcher_smsmms.png)
...
1. [SMSUnderstand](./src_cfr/com/xiaomi/smsunderstand/SMSUnderstand.java)

2. [VerificationCodeRecognition](./src_cfr/com/xiaomi/smsunderstand/task/VerificationCodeRecognition.java)

3. [SmsReceiverService](./src_cfr/com/android/mms/transaction/SmsReceiverService.java)



### Apk Info    
```
package: name='com.android.mms' versionCode='19' versionName='4.4.4-5.12.4'
sdkVersion:'19'
targetSdkVersion:'19'
