...
public class PduHeaders {
    ...
    protected void appendEncodedStringValue(EncodedStringValue encodedStringValue, int n) {
        ...
        ArrayList arrayList2 = arrayList = (ArrayList)this.mHeaderMap.get((Object)n);
        if (arrayList == null) {
            arrayList2 = new ArrayList();
        }
        arrayList2.add((Object)encodedStringValue);
        this.mHeaderMap.put((Object)n, (Object)arrayList2);
    }

    protected EncodedStringValue getEncodedStringValue(int n) {
        return (EncodedStringValue)this.mHeaderMap.get((Object)n);
    }

    protected EncodedStringValue[] getEncodedStringValues(int n) {
        ArrayList arrayList = (ArrayList)this.mHeaderMap.get((Object)n);
        if (arrayList == null) {
            return null;
        }
        return (EncodedStringValue[])arrayList.toArray((Object[])new EncodedStringValue[arrayList.size()]);
    }

    protected long getLongInteger(int n) {
        Long l = (Long)this.mHeaderMap.get((Object)n);
        if (l == null) {
            return -1;
        }
        return l;
    ...
    protected int getOctet(int n) {
        Integer n2 = (Integer)this.mHeaderMap.get((Object)n);
        if (n2 == null) {
            return 0;
        }
        return n2;
    ...
    protected byte[] getTextString(int n) {
        return (byte[])this.mHeaderMap.get((Object)n);
    }
    ...
    protected void setEncodedStringValue(EncodedStringValue encodedStringValue, int n) {
        ...
        this.mHeaderMap.put((Object)n, (Object)encodedStringValue);
    }
    ...
    protected void setEncodedStringValues(EncodedStringValue[] arrencodedStringValue, int n) {
        ...
        for (int i = 0; i < arrencodedStringValue.length; ++i) {
            arrayList.add((Object)arrencodedStringValue[i]);
        }
        this.mHeaderMap.put((Object)n, (Object)arrayList);
    }
    ...
    protected void setLongInteger(long l, int n) {
        ...
        this.mHeaderMap.put((Object)n, (Object)l);
    }
     ...
     */
    protected void setOctet(int n, int n2) throws InvalidHeaderValueException {
        int n3;
        switch (n2) {
            default: {
                throw new RuntimeException("Invalid header field!");
            ...
            case 143: {
                if (n < 128) throw new InvalidHeaderValueException("Invalid Octet value!");
                n3 = n;
                if (n <= 130) break;
                throw new InvalidHeaderValueException("Invalid Octet value!");
            }
            ...
            case 146: {
                ...
                if (!(n > 235 && n <= 255 || n < 128 || n > 136 && n < 192)) {
                    n3 = n;
                    if (n <= 255) break;
                }
                n3 = 224;
            ...
            case 140: {
                if (n < 128) throw new InvalidHeaderValueException("Invalid Octet value!");
                n3 = n;
                if (n > 151) throw new InvalidHeaderValueException("Invalid Octet value!");
            }
        }
        this.mHeaderMap.put((Object)n2, (Object)n3);
    }
    ...
    protected void setTextString(byte[] arrby, int n) {
        ...
        this.mHeaderMap.put((Object)n, (Object)arrby);
    }
}
