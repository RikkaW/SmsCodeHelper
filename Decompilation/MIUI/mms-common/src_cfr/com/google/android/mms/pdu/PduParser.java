...
public class PduParser {
    ...
    protected static byte[] getWapString(ByteArrayInputStream byteArrayInputStream, int n) {
        ...
        while (-1 != n3 && n3 != 0) {
            if (n == 2) {
                if (PduParser.isTokenCharacter(n3)) {
                    byteArrayOutputStream.write(n3);
                }
            } else if (PduParser.isText(n3)) {
                byteArrayOutputStream.write(n3);
            }
    ...
    protected static byte[] parseContentType(ByteArrayInputStream byteArrayInputStream, HashMap<Integer, Object> hashMap) {
        ...
        if ((n &= 255) < 32) {
            ...
            if (n >= 0) return arrby;
            Log.e((String)"PduParser", (String)"Corrupt MMS message");
            return PduContentTypes.contentTypes[0].getBytes();
        }
    ...
    protected static void parseContentTypeParams(ByteArrayInputStream byteArrayInputStream, HashMap<Integer, Object> hashMap, Integer n) {
        ...
        block8 : while (n3 > 0) {
            ...
            switch (n4) {
                ...
                case 137: {
                    byteArrayInputStream.mark(1);
                    n3 = PduParser.extractByteValue(byteArrayInputStream);
                    byteArrayInputStream.reset();
                    if (n3 > 127) {
                        n3 = PduParser.parseShortInteger(byteArrayInputStream);
                        if (n3 < PduContentTypes.contentTypes.length) {
                ...
                case 129: {
                    ...
                    if (n3 > 32 && n3 < 127 || n3 == 0) {
                        ...
                        try {
                            ...
                            Log.e((String)"PduParser", (String)Arrays.toString((byte[])arrby), (Throwable)var7_7);
                            hashMap.put((Object)129, (Object)0);
                        }
                    } else {
                        n3 = (int)PduParser.parseIntegerValue(byteArrayInputStream);
                        if (hashMap != null) {
    ...
    protected static EncodedStringValue parseEncodedStringValue(ByteArrayInputStream object) {
        ...
        object.reset();
        if (n2 < 32) {
            PduParser.parseValueLength((ByteArrayInputStream)object);
            n = PduParser.parseShortInteger((ByteArrayInputStream)object);
        }
        object = PduParser.parseWapString((ByteArrayInputStream)object, 0);
        ...
        block5 : while (n3 > 0) {
            ...
            if (n4 > 127) {
                switch (n4) {
                    default: {
                        if (-1 != PduParser.skipWapValue(byteArrayInputStream, n3)) break;
                        Log.e((String)"PduParser", (String)"Corrupt Part headers");
                        return false;
                    }
                    case 142: {
                        arrby = PduParser.parseWapString(byteArrayInputStream, 0);
                    ...
                    case 174: 
                    case 197: {
                        if (!Resources.getSystem().getBoolean(17891393)) continue block5;
    ...
    protected static PduBody parseParts(ByteArrayInputStream byteArrayInputStream) {
        ...
        do {
            ...
            object = new HashMap();
            byte[] arrby = PduParser.parseContentType(byteArrayInputStream, object);
            if (arrby != null) {
            ...
            if ((n3 -= n5 - byteArrayInputStream.available()) > 0 ? !PduParser.parsePartHeaders(byteArrayInputStream, pduPart, n3) : n3 < 0) {
                return null;
            }
            ...
            if (n4 > 0) {
                ...
                if (object.equalsIgnoreCase("application/vnd.wap.multipart.alternative")) {
                    object = PduParser.parseParts(new ByteArrayInputStream(arrby)).getPart(0);
                } else {
    ...
    protected PduHeaders parseHeaders(ByteArrayInputStream var1_1) {
        ...
        block80 : do {
            ...
            var1_1.mark(1);
            var3_37 = PduParser.extractByteValue(var1_1);
            ...
            switch (var3_37) {
                ...
                case 140: {
                    var4_38 = PduParser.extractByteValue(var1_1);
                    switch (var4_38) {
                        default: {
                            try {
                                ...
                                PduParser.log("Set invalid Octet value: " + var4_38 + " into the header filed: " + var3_37);
                                return null;
                            }
                        }
                        case 137: 
                    ...
                    return null;
                        ...
                        PduParser.log("" + var3_37 + "is not Octet header field!");
                        return null;
                    }
                }
                case 134: 
                ...
                case 159: {
                    try {
                        var10_36.setLongInteger(PduParser.parseLongInteger(var1_1), var3_37);
                        continue block80;
                    }
                    catch (RuntimeException var1_6) {
                        PduParser.log("" + var3_37 + "is not Long-Integer header field!");
                        return null;
                    }
                }
                case 173: 
                ...
                case 179: {
                    try {
                        var10_36.setLongInteger(PduParser.parseIntegerValue(var1_1), var3_37);
                        continue block80;
                    }
                ...
                case 189: 
                case 190: {
                    var9_27 = PduParser.parseWapString(var1_1, 0);
                    ...
                    try {
                        ...
                        PduParser.log("" + var3_37 + "is not Text-String header field!");
                        return null;
                    }
                }
                case 147: 
                ...
                case 181: 
                case 182: {
                    var9_27 = PduParser.parseEncodedStringValue(var1_1);
                    if (var9_27 == null) continue block80;
                    try {
                        ...
                        PduParser.log("" + var3_37 + "is not Encoded-String-Value header field!");
                        return null;
                    }
                }
                case 129: 
                case 130: 
                case 151: {
                    var12_43 = PduParser.parseEncodedStringValue(var1_1);
                ...
                case 157: {
                    ...
                    var4_38 = PduParser.extractByteValue(var1_1);
                    try {
                        var7_40 = var5_39 = PduParser.parseLongInteger(var1_1);
...
lbl118: // 2 sources:
                ...
                case 137: {
                    ...
                    if (128 == PduParser.extractByteValue(var1_1)) {
                        var9_27 = var11_41 = (Object)PduParser.parseEncodedStringValue(var1_1);
                        if (var11_41 != null) {
                ...
                case 141: {
                    var4_38 = PduParser.parseShortInteger(var1_1);
                    try {
                ...
                case 160: {
                    ...
                    try {
                        ...
                        PduParser.log("" + var3_37 + " is not Integer-Value");
                        return null;
                    }
                    var9_27 = PduParser.parseEncodedStringValue(var1_1);
                    if (var9_27 == null) continue block80;
                ...
                case 161: {
                    ...
                    try {
                        var10_36.setLongInteger(PduParser.parseLongInteger(var1_1), 161);
                        continue block80;
                    }
            ...
            var9_27 = new HashMap();
            var11_41 = PduParser.parseContentType(var1_1, var9_27);
            if (var11_41 != null) {
                try {
            ...
            PduParser.mStartParam = (byte[])var9_27.get((Object)153);
            PduParser.mTypeParam = (byte[])var9_27.get((Object)131);
            var2_35 = false;
        } while (true);
