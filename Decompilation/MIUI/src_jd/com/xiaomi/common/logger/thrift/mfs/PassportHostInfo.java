...
public class PassportHostInfo
  implements TBase<PassportHostInfo, _Fields>, Serializable, Cloneable
{
  private static final TField HOST_FIELD_DESC;
  private static final TField LAND_NODE_INFO_FIELD_DESC;
  private static final TStruct STRUCT_DESC = new TStruct("PassportHostInfo");
  ...
  static
  {
    ...
    localEnumMap.put(_Fields.LAND_NODE_INFO, new FieldMetaData("land_node_info", (byte)1, new ListMetaData((byte)15, new StructMetaData((byte)12, PassportLandNodeInfo.class))));
  ...
  public int compareTo(PassportHostInfo paramPassportHostInfo)
  {
    int i;
    if (!getClass().equals(paramPassportHostInfo.getClass())) {
      i = getClass().getName().compareTo(paramPassportHostInfo.getClass().getName());
    }
    int j;
    do
    {
      do
      {
        do
        {
          ...
          {
            return i;
            j = Boolean.valueOf(isSetHost()).compareTo(Boolean.valueOf(paramPassportHostInfo.isSetHost()));
            i = j;
          } while (j != 0);
          if (!isSetHost()) {
            break;
        ...
        j = Boolean.valueOf(isSetLand_node_info()).compareTo(Boolean.valueOf(paramPassportHostInfo.isSetLand_node_info()));
        i = j;
      } while (j != 0);
  ...
  public boolean equals(PassportHostInfo paramPassportHostInfo)
  {
    if (paramPassportHostInfo == null) {}
    boolean bool1;
    boolean bool2;
    do
    {
      do
      {
        return false;
        bool1 = isSetHost();
        bool2 = paramPassportHostInfo.isSetHost();
      } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!host.equals(host))));
      bool1 = isSetLand_node_info();
      bool2 = paramPassportHostInfo.isSetLand_node_info();
  ...
  {
    if (paramObject == null) {}
    while (!(paramObject instanceof PassportHostInfo)) {
      return false;
    }
    return equals((PassportHostInfo)paramObject);
  }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (type == 15)
        {
          ...
          while (i < size)
          {
            PassportLandNodeInfo localPassportLandNodeInfo = new PassportLandNodeInfo();
            localPassportLandNodeInfo.read(paramTProtocol);
            land_node_info.add(localPassportLandNodeInfo);
            i += 1;
          }
    ...
    throws TException
  {
    ...
    if (land_node_info != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((PassportLandNodeInfo)localIterator.next()).write(paramTProtocol);
      }
...
/* Location:
 * Qualified Name:     com.xiaomi.common.logger.thrift.mfs.PassportHostInfo
