  ...
  extends BaseAdapter
{
  ...
  public PhraseListAdapter(Context paramContext, int paramInt)
  {
    mContext = paramContext;
    mItemLayout = paramInt;
    mInflater = ((LayoutInflater)paramContext.getSystemService("layout_inflater"));
  }
  
  public void addPhrase(String paramString)
  {
    if (mSmsPhraseData == null) {
      return;
    }
    mSmsPhraseData.addPhrase(paramString);
  ...
  public void deletePhrase(int paramInt)
  {
    ...
    mSmsPhraseData.deletePhrase(paramInt);
    notifyDataSetChanged();
  }
  ...
  public int getCount()
  {
    ...
    return mSmsPhraseData.getCount();
  }
  ...
  public Object getItem(int paramInt)
  {
    ...
    return mSmsPhraseData.getPhrase(paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramView = mInflater.inflate(mItemLayout, paramViewGroup, false);
    }
    while ((paramView instanceof PhraseListItem))
    {
      ((PhraseListItem)paramView).bind(mSmsPhraseData.getPhrase(paramInt));
      return paramView;
    }
    return null;
  }
  ...
  {
    if (mSmsPhraseData == null) {}
    while (mSmsPhraseData.getCount() <= 50) {
      return false;
    }
    return true;
  }
  ...
  public void load()
  {
    mSmsPhraseData = new SmsPhraseData();
    notifyDataSetChanged();
  }
  ...
  public void setPhrase(int paramInt, String paramString)
  {
    ...
    mSmsPhraseData.setPhrase(paramInt, paramString);
    notifyDataSetChanged();
  }
  ...
  private class SmsPhraseData
  {
    ...
    private SharedPreferences mPref = PreferenceManager.getDefaultSharedPreferences(mContext);
    ...
    public SmsPhraseData()
    {
      ...
      this$1 = Locale.getDefault().getLanguage();
      String str = Locale.getDefault().getCountry();
      PREF_SMS_PHRASE_DATA_COUNT = ("sms_phrase_data_count_" + PhraseListAdapter.this + "_" + str);
      PREF_SMS_PHRASE_DATA = ("sms_phrase_data_" + PhraseListAdapter.this + "_" + str);
      this$1 = mPref.getString(PREF_SMS_PHRASE_DATA, "");
      ...
      parseSmsPhraseData(PhraseListAdapter.this);
    }
...
/* Location:
 * Qualified Name:     com.android.mms.ui.PhraseListAdapter
