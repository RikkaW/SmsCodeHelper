...
public abstract interface IDirParse
  extends IInterface
{
  public abstract void queryDirInfo(List<String> paramList, IQueryCallBack paramIQueryCallBack)
    ...
    implements IDirParse
  {
      ...
      implements IDirParse
    {
      ...
      /* Error */
      public void queryDirInfo(List<String> paramList, IQueryCallBack paramIQueryCallBack)
        throws RemoteException
      {
        // Byte code:
...
/* Location:
 * Qualified Name:     com.android.fileexplorer.service.IDirParse
