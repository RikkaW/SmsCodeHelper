  ...
  implements MapMakerInternalMap.ReferenceEntry<K, V>
{
  ...
  MapMakerInternalMap$SoftExpirableEvictableEntry(ReferenceQueue<K> paramReferenceQueue, K paramK, int paramInt, MapMakerInternalMap.ReferenceEntry<K, V> paramReferenceEntry)
  {
