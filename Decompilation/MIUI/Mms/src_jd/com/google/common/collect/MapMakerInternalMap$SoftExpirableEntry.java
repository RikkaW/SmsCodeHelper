  ...
  implements MapMakerInternalMap.ReferenceEntry<K, V>
{
  ...
  MapMakerInternalMap$SoftExpirableEntry(ReferenceQueue<K> paramReferenceQueue, K paramK, int paramInt, MapMakerInternalMap.ReferenceEntry<K, V> paramReferenceEntry)
  {
