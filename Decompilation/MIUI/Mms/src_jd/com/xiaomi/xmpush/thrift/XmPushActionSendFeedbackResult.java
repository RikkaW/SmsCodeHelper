...
public class XmPushActionSendFeedbackResult
  implements TBase<XmPushActionSendFeedbackResult, _Fields>, Serializable, Cloneable
{
  ...
  static
  {
    ...
    CATEGORY_FIELD_DESC = new TField("category", (byte)11, (short)8);
    ...
    localEnumMap.put(_Fields.REQUEST, new FieldMetaData("request", (byte)2, new StructMetaData((byte)12, XmPushActionSendFeedback.class)));
  ...
  public int compareTo(XmPushActionSendFeedbackResult paramXmPushActionSendFeedbackResult)
  {
    int i;
    if (!getClass().equals(paramXmPushActionSendFeedbackResult.getClass())) {
      i = getClass().getName().compareTo(paramXmPushActionSendFeedbackResult.getClass().getName());
    }
    int j;
    do
    {
      do
      {
        do
        {
          do
          {
              ...
              do
              {
                do
                {
                  do
                  {
                      ...
                      do
                      {
                        do
                        {
                          do
                          {
                            do
                            {
                              do
                              {
                                do
                                {
                                  ...
                                  {
                                    return i;
                                    j = Boolean.valueOf(isSetDebug()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetDebug()));
                                    i = j;
                                  } while (j != 0);
                                  if (!isSetDebug()) {
                                    break;
                                ...
                                j = Boolean.valueOf(isSetTarget()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetTarget()));
                                i = j;
                              } while (j != 0);
                              if (!isSetTarget()) {
                                break;
                            ...
                            j = Boolean.valueOf(isSetId()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetId()));
                            i = j;
                          } while (j != 0);
                          if (!isSetId()) {
                            break;
                        ...
                        j = Boolean.valueOf(isSetAppId()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetAppId()));
                        i = j;
                      } while (j != 0);
                      if (!isSetAppId()) {
                        break;
                    ...
                    j = Boolean.valueOf(isSetRequest()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetRequest()));
                    i = j;
                  } while (j != 0);
                  if (!isSetRequest()) {
                    break;
                ...
                j = Boolean.valueOf(isSetErrorCode()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetErrorCode()));
                i = j;
              } while (j != 0);
              if (!isSetErrorCode()) {
                break;
            ...
            j = Boolean.valueOf(isSetReason()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetReason()));
            i = j;
          } while (j != 0);
          if (!isSetReason()) {
            break;
        ...
        j = Boolean.valueOf(isSetCategory()).compareTo(Boolean.valueOf(paramXmPushActionSendFeedbackResult.isSetCategory()));
        i = j;
      } while (j != 0);
      if (!isSetCategory()) {
        break;
  ...
  public boolean equals(XmPushActionSendFeedbackResult paramXmPushActionSendFeedbackResult)
  {
    if (paramXmPushActionSendFeedbackResult == null) {
      return false;
    }
    boolean bool1 = isSetDebug();
    boolean bool2 = paramXmPushActionSendFeedbackResult.isSetDebug();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetTarget();
    bool2 = paramXmPushActionSendFeedbackResult.isSetTarget();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetId();
    bool2 = paramXmPushActionSendFeedbackResult.isSetId();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetAppId();
    bool2 = paramXmPushActionSendFeedbackResult.isSetAppId();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetRequest();
    bool2 = paramXmPushActionSendFeedbackResult.isSetRequest();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetReason();
    bool2 = paramXmPushActionSendFeedbackResult.isSetReason();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetCategory();
    bool2 = paramXmPushActionSendFeedbackResult.isSetCategory();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
  ...
  {
    if (paramObject == null) {}
    while (!(paramObject instanceof XmPushActionSendFeedbackResult)) {
      return false;
    }
    return equals((XmPushActionSendFeedbackResult)paramObject);
  }
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if (type == 12)
                {
                  request = new XmPushActionSendFeedback();
...
/* Location:
 * Qualified Name:     com.xiaomi.xmpush.thrift.XmPushActionSendFeedbackResult
