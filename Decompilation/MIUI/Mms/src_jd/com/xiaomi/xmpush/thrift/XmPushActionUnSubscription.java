...
public class XmPushActionUnSubscription
  implements TBase<XmPushActionUnSubscription, _Fields>, Serializable, Cloneable
{
  ...
  public int compareTo(XmPushActionUnSubscription paramXmPushActionUnSubscription)
  {
    int i;
    if (!getClass().equals(paramXmPushActionUnSubscription.getClass())) {
      i = getClass().getName().compareTo(paramXmPushActionUnSubscription.getClass().getName());
    }
    int j;
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                            do
                            {
                              ...
                              {
                                return i;
                                j = Boolean.valueOf(isSetDebug()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetDebug()));
                                i = j;
                              } while (j != 0);
                              if (!isSetDebug()) {
                                break;
                            ...
                            j = Boolean.valueOf(isSetTarget()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetTarget()));
                            i = j;
                          } while (j != 0);
                          if (!isSetTarget()) {
                            break;
                        ...
                        j = Boolean.valueOf(isSetId()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetId()));
                        i = j;
                      } while (j != 0);
                      if (!isSetId()) {
                        break;
                    ...
                    j = Boolean.valueOf(isSetAppId()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetAppId()));
                    i = j;
                  } while (j != 0);
                  if (!isSetAppId()) {
                    break;
                ...
                j = Boolean.valueOf(isSetTopic()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetTopic()));
                i = j;
              } while (j != 0);
              if (!isSetTopic()) {
                break;
            ...
            j = Boolean.valueOf(isSetPackageName()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetPackageName()));
            i = j;
          } while (j != 0);
          if (!isSetPackageName()) {
            break;
        ...
        j = Boolean.valueOf(isSetCategory()).compareTo(Boolean.valueOf(paramXmPushActionUnSubscription.isSetCategory()));
        i = j;
      } while (j != 0);
      if (!isSetCategory()) {
        break;
  ...
  public boolean equals(XmPushActionUnSubscription paramXmPushActionUnSubscription)
  {
    if (paramXmPushActionUnSubscription == null) {
      return false;
    }
    boolean bool1 = isSetDebug();
    boolean bool2 = paramXmPushActionUnSubscription.isSetDebug();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetTarget();
    bool2 = paramXmPushActionUnSubscription.isSetTarget();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetId();
    bool2 = paramXmPushActionUnSubscription.isSetId();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetAppId();
    bool2 = paramXmPushActionUnSubscription.isSetAppId();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetTopic();
    bool2 = paramXmPushActionUnSubscription.isSetTopic();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool2 = paramXmPushActionUnSubscription.isSetPackageName();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
    ...
    bool1 = isSetCategory();
    bool2 = paramXmPushActionUnSubscription.isSetCategory();
    if ((bool1) || (bool2))
    {
      if ((!bool1) || (!bool2)) {
        return false;
  ...
  {
    if (paramObject == null) {}
    while (!(paramObject instanceof XmPushActionUnSubscription)) {
      return false;
    }
    return equals((XmPushActionUnSubscription)paramObject);
  }
...
/* Location:
 * Qualified Name:     com.xiaomi.xmpush.thrift.XmPushActionUnSubscription
