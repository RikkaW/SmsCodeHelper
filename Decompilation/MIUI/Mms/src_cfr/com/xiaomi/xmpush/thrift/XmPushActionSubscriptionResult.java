...
implements TBase<XmPushActionSubscriptionResult, _Fields>,
Serializable,
Cloneable {
    ...
    static {
        ...
        enumMap.put(_Fields.REQUEST, new FieldMetaData("request", 2, new StructMetaData(12, XmPushActionSubscription.class)));
    ...
    public int compareTo(XmPushActionSubscriptionResult xmPushActionSubscriptionResult) {
        int n;
        if (!this.getClass().equals((Object)xmPushActionSubscriptionResult.getClass())) {
            return this.getClass().getName().compareTo(xmPushActionSubscriptionResult.getClass().getName());
        }
        int n2 = n = Boolean.valueOf((boolean)this.isSetDebug()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetDebug()));
        if (n != 0) return n2;
        if (this.isSetDebug()) {
            n2 = n = TBaseHelper.compareTo(this.debug, xmPushActionSubscriptionResult.debug);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetTarget()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetTarget()));
        if (n != 0) return n2;
        if (this.isSetTarget()) {
            n2 = n = TBaseHelper.compareTo(this.target, xmPushActionSubscriptionResult.target);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetId()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetId()));
        if (n != 0) return n2;
        if (this.isSetId()) {
            n2 = n = TBaseHelper.compareTo(this.id, xmPushActionSubscriptionResult.id);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetAppId()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetAppId()));
        if (n != 0) return n2;
        if (this.isSetAppId()) {
            n2 = n = TBaseHelper.compareTo(this.appId, xmPushActionSubscriptionResult.appId);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetRequest()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetRequest()));
        if (n != 0) return n2;
        if (this.isSetRequest()) {
            n2 = n = TBaseHelper.compareTo(this.request, xmPushActionSubscriptionResult.request);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetErrorCode()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetErrorCode()));
        if (n != 0) return n2;
        if (this.isSetErrorCode()) {
            n2 = n = TBaseHelper.compareTo(this.errorCode, xmPushActionSubscriptionResult.errorCode);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetReason()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetReason()));
        if (n != 0) return n2;
        if (this.isSetReason()) {
            n2 = n = TBaseHelper.compareTo(this.reason, xmPushActionSubscriptionResult.reason);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetTopic()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetTopic()));
        if (n != 0) return n2;
        if (this.isSetTopic()) {
            n2 = n = TBaseHelper.compareTo(this.topic, xmPushActionSubscriptionResult.topic);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetPackageName()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetPackageName()));
        if (n != 0) return n2;
        if (this.isSetPackageName()) {
            n2 = n = TBaseHelper.compareTo(this.packageName, xmPushActionSubscriptionResult.packageName);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetCategory()).compareTo(Boolean.valueOf((boolean)xmPushActionSubscriptionResult.isSetCategory()));
        if (n != 0) return n2;
        if (!this.isSetCategory()) return 0;
        n2 = n = TBaseHelper.compareTo(this.category, xmPushActionSubscriptionResult.category);
        if (n != 0) return n2;
        return 0;
    }
    ...
    public boolean equals(XmPushActionSubscriptionResult xmPushActionSubscriptionResult) {
        ...
        boolean bl2 = xmPushActionSubscriptionResult.isSetDebug();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.debug.equals((Object)xmPushActionSubscriptionResult.debug)) {
                return false;
            }
        }
        bl = this.isSetTarget();
        bl2 = xmPushActionSubscriptionResult.isSetTarget();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.target.equals(xmPushActionSubscriptionResult.target)) {
                return false;
            }
        }
        bl = this.isSetId();
        bl2 = xmPushActionSubscriptionResult.isSetId();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.id.equals((Object)xmPushActionSubscriptionResult.id)) {
                return false;
            }
        }
        bl = this.isSetAppId();
        bl2 = xmPushActionSubscriptionResult.isSetAppId();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.appId.equals((Object)xmPushActionSubscriptionResult.appId)) {
                return false;
            }
        }
        bl = this.isSetRequest();
        bl2 = xmPushActionSubscriptionResult.isSetRequest();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.request.equals(xmPushActionSubscriptionResult.request)) {
                return false;
            }
        }
        bl = this.isSetErrorCode();
        bl2 = xmPushActionSubscriptionResult.isSetErrorCode();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (this.errorCode != xmPushActionSubscriptionResult.errorCode) {
                return false;
            }
        }
        bl = this.isSetReason();
        bl2 = xmPushActionSubscriptionResult.isSetReason();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.reason.equals((Object)xmPushActionSubscriptionResult.reason)) {
                return false;
            }
        }
        bl = this.isSetTopic();
        bl2 = xmPushActionSubscriptionResult.isSetTopic();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.topic.equals((Object)xmPushActionSubscriptionResult.topic)) {
                return false;
            }
        }
        bl = this.isSetPackageName();
        bl2 = xmPushActionSubscriptionResult.isSetPackageName();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.packageName.equals((Object)xmPushActionSubscriptionResult.packageName)) {
                return false;
            }
        }
        bl = this.isSetCategory();
        bl2 = xmPushActionSubscriptionResult.isSetCategory();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.category.equals((Object)xmPushActionSubscriptionResult.category)) {
                return false;
            }
        }
        return true;
    ...
    public boolean equals(Object object) {
        if (object == null || !(object instanceof XmPushActionSubscriptionResult)) {
            return false;
        }
        return this.equals((XmPushActionSubscriptionResult)object);
    }
    ...
    public String toString() {
        ...
        block36 : {
            stringBuilder = new StringBuilder("XmPushActionSubscriptionResult(");
            boolean bl = true;
            if (this.isSetDebug()) {
