...
import com.xiaomi.common.logger.thrift.mfs.PassportLandNodeInfo;
...
implements TBase<PassportHostInfo, _Fields>,
Serializable,
Cloneable {
    ...
    static {
        ...
        enumMap.put(_Fields.LAND_NODE_INFO, new FieldMetaData("land_node_info", 1, new ListMetaData(15, new StructMetaData(12, PassportLandNodeInfo.class))));
    ...
    public int compareTo(PassportHostInfo passportHostInfo) {
        int n;
        if (!this.getClass().equals((Object)passportHostInfo.getClass())) {
            return this.getClass().getName().compareTo(passportHostInfo.getClass().getName());
        }
        int n2 = n = Boolean.valueOf((boolean)this.isSetHost()).compareTo(Boolean.valueOf((boolean)passportHostInfo.isSetHost()));
        if (n != 0) return n2;
        if (this.isSetHost()) {
            n2 = n = TBaseHelper.compareTo(this.host, passportHostInfo.host);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetLand_node_info()).compareTo(Boolean.valueOf((boolean)passportHostInfo.isSetLand_node_info()));
        if (n != 0) return n2;
        if (!this.isSetLand_node_info()) return 0;
        n2 = n = TBaseHelper.compareTo(this.land_node_info, passportHostInfo.land_node_info);
        if (n != 0) return n2;
        return 0;
    }
     ...
     * Lifted jumps to return sites
     */
    public boolean equals(PassportHostInfo passportHostInfo) {
        if (passportHostInfo == null) {
            return false;
        }
        boolean bl = this.isSetHost();
        boolean bl2 = passportHostInfo.isSetHost();
        if (bl || bl2) {
            if (!bl) return false;
            if (!bl2) return false;
            if (!this.host.equals((Object)passportHostInfo.host)) return false;
        }
        bl = this.isSetLand_node_info();
        bl2 = passportHostInfo.isSetLand_node_info();
        if (!bl) {
            if (!bl2) return true;
        }
        if (!bl) return false;
        if (!bl2) return false;
        if (!this.land_node_info.equals(passportHostInfo.land_node_info)) return false;
        return true;
    }
    ...
    public boolean equals(Object object) {
        if (object == null || !(object instanceof PassportHostInfo)) {
            return false;
        }
        return this.equals((PassportHostInfo)object);
    }
                ...
                case 2: {
                    if (object.type == 15) {
                        ...
                        for (int i = 0; i < object.size; ++i) {
                            ...
                            passportLandNodeInfo.read(tProtocol);
    ...
    public void write(TProtocol tProtocol) throws TException {
        ...
        if (this.land_node_info != null) {
            ...
            Iterator<PassportLandNodeInfo> iterator = this.land_node_info.iterator();
