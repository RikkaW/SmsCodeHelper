...
public class XmPushActionUnSubscription
implements TBase<XmPushActionUnSubscription, _Fields>,
Serializable,
Cloneable {
    ...
    public int compareTo(XmPushActionUnSubscription xmPushActionUnSubscription) {
        int n;
        if (!this.getClass().equals((Object)xmPushActionUnSubscription.getClass())) {
            return this.getClass().getName().compareTo(xmPushActionUnSubscription.getClass().getName());
        }
        int n2 = n = Boolean.valueOf((boolean)this.isSetDebug()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetDebug()));
        if (n != 0) return n2;
        if (this.isSetDebug()) {
            n2 = n = TBaseHelper.compareTo(this.debug, xmPushActionUnSubscription.debug);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetTarget()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetTarget()));
        if (n != 0) return n2;
        if (this.isSetTarget()) {
            n2 = n = TBaseHelper.compareTo(this.target, xmPushActionUnSubscription.target);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetId()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetId()));
        if (n != 0) return n2;
        if (this.isSetId()) {
            n2 = n = TBaseHelper.compareTo(this.id, xmPushActionUnSubscription.id);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetAppId()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetAppId()));
        if (n != 0) return n2;
        if (this.isSetAppId()) {
            n2 = n = TBaseHelper.compareTo(this.appId, xmPushActionUnSubscription.appId);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetTopic()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetTopic()));
        if (n != 0) return n2;
        if (this.isSetTopic()) {
            n2 = n = TBaseHelper.compareTo(this.topic, xmPushActionUnSubscription.topic);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetPackageName()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetPackageName()));
        if (n != 0) return n2;
        if (this.isSetPackageName()) {
            n2 = n = TBaseHelper.compareTo(this.packageName, xmPushActionUnSubscription.packageName);
            if (n != 0) return n2;
        }
        n2 = n = Boolean.valueOf((boolean)this.isSetCategory()).compareTo(Boolean.valueOf((boolean)xmPushActionUnSubscription.isSetCategory()));
        if (n != 0) return n2;
        if (!this.isSetCategory()) return 0;
        n2 = n = TBaseHelper.compareTo(this.category, xmPushActionUnSubscription.category);
        if (n != 0) return n2;
        return 0;
    }
    ...
    public boolean equals(XmPushActionUnSubscription xmPushActionUnSubscription) {
        ...
        boolean bl2 = xmPushActionUnSubscription.isSetDebug();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.debug.equals((Object)xmPushActionUnSubscription.debug)) {
                return false;
            }
        }
        bl = this.isSetTarget();
        bl2 = xmPushActionUnSubscription.isSetTarget();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.target.equals(xmPushActionUnSubscription.target)) {
                return false;
            }
        }
        bl = this.isSetId();
        bl2 = xmPushActionUnSubscription.isSetId();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.id.equals((Object)xmPushActionUnSubscription.id)) {
                return false;
            }
        }
        bl = this.isSetAppId();
        bl2 = xmPushActionUnSubscription.isSetAppId();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.appId.equals((Object)xmPushActionUnSubscription.appId)) {
                return false;
            }
        }
        bl = this.isSetTopic();
        bl2 = xmPushActionUnSubscription.isSetTopic();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.topic.equals((Object)xmPushActionUnSubscription.topic)) {
                return false;
            }
        }
        bl = this.isSetPackageName();
        bl2 = xmPushActionUnSubscription.isSetPackageName();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.packageName.equals((Object)xmPushActionUnSubscription.packageName)) {
                return false;
            }
        }
        bl = this.isSetCategory();
        bl2 = xmPushActionUnSubscription.isSetCategory();
        if (bl || bl2) {
            if (!bl || !bl2) {
                return false;
            }
            if (!this.category.equals((Object)xmPushActionUnSubscription.category)) {
                return false;
            }
        }
        return true;
    ...
    public boolean equals(Object object) {
        if (object == null || !(object instanceof XmPushActionUnSubscription)) {
            return false;
        }
        return this.equals((XmPushActionUnSubscription)object);
    }
    ...
    public String toString() {
        ...
        block24 : {
            stringBuilder = new StringBuilder("XmPushActionUnSubscription(");
            boolean bl = true;
            if (this.isSetDebug()) {
