...
public abstract class PushConstants {
    ...
    public static String EXTRA_NOTIFY_ID;
    ...
    public static String EXTRA_SIG;
    public static String EXTRA_TOKEN;
    public static String EXTRA_USER_ID;
    public static String NOTIFICATION_CLICK_DEFAULT;
    public static String NOTIFICATION_CLICK_INTENT;
    public static String NOTIFICATION_CLICK_WEB_PAGE;

    static {
        NOTIFICATION_CLICK_DEFAULT = "1";
        NOTIFICATION_CLICK_INTENT = "2";
        ...
        EXTRA_NOTIFY_TYPE = "ext_notify_type";
