...
public class aji {
    private static Object a(Class<?> method, Object object, String string2, Class<?>[] arrclass, Object[] arrobject) {
        if (arrobject == null || arrobject.length == 0) {
            method = method.getMethod(string2, new Class[0]);
            method.setAccessible(true);
            return method.invoke(object, new Object[0]);
        }
        method = method.getMethod(string2, arrclass);
        method.setAccessible(true);
    ...
    private static Object a(Class<?> method, Object object, String string2, Object[] arrobject) {
        ...
        method = method.getMethod(string2, aji.a(arrobject));
        method.setAccessible(true);
        return method.invoke(object, arrobject);
    }
    ...
    public static Object a(Object object, String string2, Class<?>[] arrclass, Object[] arrobject) {
        return aji.a(object.getClass(), object, string2, arrclass, arrobject);
    }
    ...
    public static Object a(String string2, String string3) {
        ...
        return aji.b(string2, string2, string3);
    }

    public static Object a(String string2, String string3, Class<?>[] arrclass, Object[] arrobject) {
        string2 = Class.forName((String)string2);
        return aji.a(string2, string2, string3, arrclass, arrobject);
    }

    public static Object a(String string2, String string3, Object[] arrobject) {
        string2 = Class.forName((String)string2);
        return aji.a(string2, (Object)string2, string3, arrobject);
    }
    ...
    private static Object b(Object object, Class<?> class_, String string2) {
        while (class_ != null) {
            try {
                Object object2 = aji.a(object, class_, string2);
                return object2;
            }
