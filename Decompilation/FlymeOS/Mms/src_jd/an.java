    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((l.a.c == ((m)localObject).a()) && (l.a.c == paramArrayOfm.a()))
        {
          ...
          if (localObject != null) {
            return new m(l.a.c, Boolean.valueOf(((Boolean)localObject).equals(paramArrayOfm)));
          }
        ...
        if ((l.a.h == ((m)localObject).a()) && (l.a.h == paramArrayOfm.a()))
        {
          ...
          if (localObject != null) {
            return new m(l.a.c, Boolean.valueOf(((String)localObject).equals(paramArrayOfm)));
          }
          if (paramArrayOfm == null) {
            return new m(l.a.c, Boolean.TRUE);
          }
        ...
        if ((l.a.j == ((m)localObject).a()) && (l.a.j == paramArrayOfm.a()))
        {
          ...
          if (localObject != null) {
            return new m(l.a.c, Boolean.valueOf(localObject.equals(paramArrayOfm)));
          }
          if (paramArrayOfm == null) {
            return new m(l.a.c, Boolean.TRUE);
          }
