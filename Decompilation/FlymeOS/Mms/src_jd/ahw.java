  ...
  implements Closeable
{
  ...
  public ahw(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
  ...
  public ahw(InputStream paramInputStream, Charset paramCharset)
  {
  ...
  public String a()
  {
    ...
    for (;;)
    {
      ...
      for (int j = i - 1;; j = i)
      {
        ...
        localObject2 = new ahx(this, e - d + 80);
        for (;;)
        {
