...
public class aaq
{
  private final aaq.b a;
  private boolean b;
  
  public aaq(Context paramContext, aaq.a parama)
  {
    paramContext = (SensorManager)paramContext.getSystemService("sensor");
    Sensor localSensor = paramContext.getDefaultSensor(8);
    if (localSensor == null)
    {
      a = null;
      return;
    }
    a = new aaq.b(paramContext, localSensor, parama);
  }
    ...
    implements SensorEventListener
  {
    ...
    public b(SensorManager paramSensorManager, Sensor paramSensor, aaq.a parama)
    {
