...
public abstract class PinnedHeaderIndexerListAdapter
  extends PinnedHeaderListAdapter
  implements SectionIndexer
{
  ...
  public PinnedHeaderIndexerListAdapter(Context paramContext)
  {
    super(paramContext);
  ...
  public void configurePinnedHeaders(PinnedHeaderListView paramPinnedHeaderListView)
  {
    ...
    int m = paramPinnedHeaderListView.getPositionAt(paramPinnedHeaderListView.getTotalTopPinnedHeaderHeight() + paramPinnedHeaderListView.getHeaderPaddingTop());
    ...
    for (i = getSectionForPosition(j);; i = -1)
    {
      ...
      if ((mLastSection == i) && (i != -1) && (getSectionPosition(i) == n)) {
        configureItemHeader(paramPinnedHeaderListView, m, i, true);
      }
      mLastSection = i;
...
/* Location:
 * Qualified Name:     com.meizu.common.widget.PinnedHeaderIndexerListAdapter
