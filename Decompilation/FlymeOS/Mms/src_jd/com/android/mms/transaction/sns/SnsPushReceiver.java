  ...
  extends BroadcastReceiver
{
  ...
  {
    Log.e("SnsPushReceiver", "Received PUSH Intent: " + paramIntent);
    if ((paramIntent.getAction().equals("android.provider.Telephony.WAP_PUSH_RECEIVED")) && ("application/vnd.sns.mms-message".equals(paramIntent.getType())))
    {
      ((PowerManager)paramContext.getSystemService("power")).newWakeLock(1, "MMS SnsPushReceiver").acquire(5000L);
...
/* Location:
 * Qualified Name:     com.android.mms.transaction.sns.SnsPushReceiver
