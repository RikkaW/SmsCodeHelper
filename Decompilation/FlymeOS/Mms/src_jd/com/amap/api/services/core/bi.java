...
abstract class bi
{
  ...
  private String a(Context paramContext, ad paramad)
  {
    return y.a(paramContext, paramad);
  }
  ...
  private String a(Context paramContext, String paramString)
  {
    try
    {
      paramContext = y.a(paramContext, paramString.getBytes("UTF-8"));
      return paramContext;
    }
  ...
  private void a(ak paramak, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    am localam = new am();
    localam.a(0);
    localam.b(paramString1);
    localam.a(paramString2);
    paramak.b(localam, paramInt);
  }
  
  /* Error */
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, ak paramak)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 16
    ...
    //   110: astore 10
    //   112: aload 21
    //   114: getstatic 118	com/amap/api/services/core/bf:a	Ljava/lang/String;
    ...
    //   314: iconst_1
    //   315: ldc2_w 132
    //   318: invokestatic 138	com/amap/api/services/core/bk:a	(Ljava/io/File;IIJ)Lcom/amap/api/services/core/bk;
    //   321: astore_1
    //   322: aload_1
    //   323: astore 11
    //   325: aload 15
    ...
    //   344: aload_0
    //   345: aload 5
    //   347: invokevirtual 141	com/amap/api/services/core/bi:a	(Lcom/amap/api/services/core/ak;)Lcom/amap/api/services/core/bn;
    //   350: invokevirtual 144	com/amap/api/services/core/bk:a	(Lcom/amap/api/services/core/bn;)V
    //   353: aload_1
    //   354: astore 11
    //   356: aload 15
    //   358: astore 13
    ...
    //   374: aload_1
    //   375: aload_2
    //   376: invokevirtual 147	com/amap/api/services/core/bk:a	(Ljava/lang/String;)Lcom/amap/api/services/core/bk$b;
    //   379: astore_3
    //   380: aload_3
    //   381: ifnull +58 -> 439
    //   384: iconst_0
    ...
    //   412: istore 6
    //   414: aload_1
    //   415: invokevirtual 149	com/amap/api/services/core/bk:a	()Z
    //   418: ifne -133 -> 285
    //   421: aload_1
    //   422: invokevirtual 152	com/amap/api/services/core/bk:close	()V
    //   425: iconst_0
    //   426: ireturn
    //   427: astore_1
    //   428: iload 7
    ...
    //   489: aload_1
    //   490: aload_2
    //   491: invokevirtual 155	com/amap/api/services/core/bk:b	(Ljava/lang/String;)Lcom/amap/api/services/core/bk$a;
    //   494: astore 4
    //   496: aload_1
    //   497: astore 11
    //   499: aload 15
    ...
    //   517: aload 4
    //   519: iconst_0
    //   520: invokevirtual 160	com/amap/api/services/core/bk$a:a	(I)Ljava/io/OutputStream;
    //   523: astore_2
    //   524: aload_1
    //   525: astore 11
    //   527: aload_2
    ...
    //   563: astore 10
    //   565: aload 4
    //   567: invokevirtual 168	com/amap/api/services/core/bk$a:a	()V
    //   570: aload_1
    //   571: astore 11
    //   573: aload_2
    //   574: astore 13
    ...
    //   586: astore 10
    //   588: aload_1
    //   589: invokevirtual 170	com/amap/api/services/core/bk:b	()V
    //   592: iconst_1
    //   593: istore 7
    //   595: iconst_1
    //   596: istore 8
    ...
    //   616: istore 6
    //   618: aload_1
    //   619: invokevirtual 149	com/amap/api/services/core/bk:a	()Z
    //   622: ifne -337 -> 285
    //   625: aload_1
    //   626: invokevirtual 152	com/amap/api/services/core/bk:close	()V
    //   629: iconst_1
    //   630: ireturn
    //   631: astore_1
    //   632: iload 7
    ...
    //   664: ifnull +16 -> 680
    //   667: aload 11
    //   669: invokevirtual 149	com/amap/api/services/core/bk:a	()Z
    //   672: ifne +8 -> 680
    //   675: aload 11
    //   677: invokevirtual 152	com/amap/api/services/core/bk:close	()V
    //   680: iconst_0
    //   681: ireturn
    //   682: astore_1
    //   683: aload 12
    ...
    //   707: ifnull -27 -> 680
    //   710: aload 12
    //   712: invokevirtual 149	com/amap/api/services/core/bk:a	()Z
    //   715: ifne -35 -> 680
    //   718: aload 12
    //   720: invokevirtual 152	com/amap/api/services/core/bk:close	()V
    //   723: goto -43 -> 680
    //   726: astore_1
    //   727: aload_1
    ...
    //   747: ifnull +16 -> 763
    //   750: aload 9
    //   752: invokevirtual 149	com/amap/api/services/core/bk:a	()Z
    //   755: ifne +8 -> 763
    //   758: aload 9
    //   760: invokevirtual 152	com/amap/api/services/core/bk:close	()V
    //   763: aload_1
    //   764: athrow
    //   765: astore_2
    //   766: aload_2
    ...
    //   385	248	7	bool2	boolean
    //   388	227	8	bool3	boolean
    //   36	723	9	localObject1	Object
    //   40	701	10	localObject2	Object
    //   20	656	11	localObject3	Object
    //   28	691	12	localObject4	Object
    //   24	634	13	localObject5	Object
    //   32	669	14	localObject6	Object
    //   7	493	15	localObject7	Object
    //   1	506	16	localObject8	Object
  ...
  /* Error */
  private List<ad> b(Context paramContext)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   7: aload 4
    //   9: monitorenter
    //   10: new 183	com/amap/api/services/core/an
    //   13: dup
    //   14: aload_1
    //   15: invokespecial 186	com/amap/api/services/core/an:<init>	(Landroid/content/Context;)V
    //   18: invokevirtual 189	com/amap/api/services/core/an:a	()Ljava/util/List;
    //   21: astore_1
    //   22: aload 4
    //   24: monitorexit
    //   25: aload_1
  ...
  {
    return w.e(paramContext);
  }
  
  protected abstract int a();
  
  protected abstract bn a(ak paramak);
  ...
  protected String a(Throwable paramThrowable)
  {
    try
    {
      paramThrowable = bj.a(paramThrowable);
  ...
  protected abstract String a(List<ad> paramList);
  ...
  void a(Context paramContext)
  {
    ...
    synchronized (Looper.getMainLooper())
    {
      ...
      boolean bool = a(paramContext, (String)localObject1, str2, str1, localak);
      a(localak, a.a(), (String)localObject1, i, bool);
      return;
    }
  }
  ...
  void a(Context paramContext, Throwable paramThrowable, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      a(localad);
      ??? = c();
      String str3 = a(paramContext, localad);
      ...
      synchronized (Looper.getMainLooper())
      {
        localObject3 = new ak(paramContext);
        boolean bool = a(paramContext, str2, str4, str3, (ak)localObject3);
        a((ak)localObject3, localad.a(), str2, i, bool);
      }
    }
  }
...
/* Location:
 * Qualified Name:     com.amap.api.services.core.bi
