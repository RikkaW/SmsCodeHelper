...
public class ac
{
  ...
  private static HttpHost b(Context paramContext)
  {
    ...
    //   1: istore_3
    //   2: aload_0
    //   3: invokestatic 65	com/amap/api/services/core/z:g	(Landroid/content/Context;)I
    //   6: ifne +752 -> 758
    //   9: ldc -119
    ...
    //   118: aload 5
    //   120: astore 7
    //   122: invokestatic 188	com/amap/api/services/core/ac:a	()Ljava/lang/String;
    //   125: astore 6
    //   127: aload 5
    //   129: astore 7
    //   131: invokestatic 190	com/amap/api/services/core/ac:b	()I
    //   134: istore_2
    //   135: aload 5
    //   137: astore 7
    //   139: aload 6
    ...
    //   216: aload 6
    //   218: iload_2
    //   219: invokestatic 113	com/amap/api/services/core/ac:a	(Ljava/lang/String;I)Z
    //   222: ifeq +536 -> 758
    ...
    //   257: aload 5
    //   259: astore 7
    //   261: invokestatic 188	com/amap/api/services/core/ac:a	()Ljava/lang/String;
    //   264: astore 6
    //   266: aload 5
    //   268: astore 7
    //   270: invokestatic 190	com/amap/api/services/core/ac:b	()I
    //   273: istore_1
    //   274: aload 5
    //   276: astore 7
    //   278: aload 6
    ...
    //   324: goto -130 -> 194
    //   327: astore 5
    //   329: invokestatic 210	com/amap/api/services/core/ay:b	()Lcom/amap/api/services/core/ay;
    //   332: astore 6
    //   334: aload 6
    //   336: ifnull +14 -> 350
    //   339: aload 6
    ...
    //   343: ldc 25
    //   345: ldc -44
    //   347: invokevirtual 214	com/amap/api/services/core/ay:b	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   350: aload 5
    ...
    //   382: ldc 25
    //   384: ldc -40
    //   386: invokestatic 32	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   389: aload 5
    //   391: astore 7
    //   393: aload_0
    //   394: invokestatic 220	com/amap/api/services/core/z:i	(Landroid/content/Context;)Ljava/lang/String;
    //   397: astore_0
    //   398: aload_0
    //   399: ifnull +450 -> 849
    //   402: aload 5
    ...
    //   414: aload 5
    //   416: astore 7
    //   418: invokestatic 188	com/amap/api/services/core/ac:a	()Ljava/lang/String;
    //   421: astore 8
    //   423: aload 5
    //   425: astore 7
    //   427: invokestatic 190	com/amap/api/services/core/ac:b	()I
    //   430: istore_2
    //   431: aload 5
    //   433: astore 7
    //   435: aload_0
    ...
    //   526: goto -310 -> 216
    //   529: astore 5
    //   531: invokestatic 210	com/amap/api/services/core/ay:b	()Lcom/amap/api/services/core/ay;
    //   534: astore 6
    //   536: aload 6
    //   538: ifnull +14 -> 552
    //   541: aload 6
    ...
    //   545: ldc 25
    //   547: ldc -44
    //   549: invokevirtual 214	com/amap/api/services/core/ay:b	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   552: aload 5
    ...
    //   638: ldc 25
    //   640: ldc -31
    //   642: invokestatic 32	com/amap/api/services/core/ay:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   645: aload 5
    ...
    //   672: goto -456 -> 216
    //   675: astore_0
    //   676: invokestatic 210	com/amap/api/services/core/ay:b	()Lcom/amap/api/services/core/ay;
    //   679: astore 5
    //   681: aload 5
    //   683: ifnull +13 -> 696
    //   686: aload 5
    ...
    //   689: ldc 25
    //   691: ldc -44
    //   693: invokevirtual 214	com/amap/api/services/core/ay:b	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   696: aload_0
    ...
    //   726: athrow
    //   727: astore 5
    //   729: invokestatic 210	com/amap/api/services/core/ay:b	()Lcom/amap/api/services/core/ay;
    //   732: astore 6
    //   734: aload 6
    //   736: ifnull +14 -> 750
    //   739: aload 6
    ...
    //   743: ldc 25
    //   745: ldc -44
    //   747: invokevirtual 214	com/amap/api/services/core/ay:b	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   750: aload 5
