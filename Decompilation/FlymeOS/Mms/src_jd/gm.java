...
import android.telephony.MzPhoneNumberUtilsExt;
...
public class gm
{
  private static gm.a a;
  private static final ContentObserver b = new gn(new Handler());
  private static final HashSet<gm.b> c = new HashSet();
  private long d;
  private int e;
  private String f;
  private String g;
  ...
  private gm(String paramString)
  {
    a(paramString, "");
  }
  
  private gm(boolean paramBoolean)
  {
    a("Self_Item_Key", "");
    u = paramBoolean;
  }
  
  public static gm a(String paramString, boolean paramBoolean)
  {
  ...
  {
    if (!aau.d(paramString2)) {}
    for (paramString3 = MzPhoneNumberUtilsExt.formatNumber(paramString2, paramString3, MmsApp.c().h());; paramString3 = paramString2)
    {
  ...
  public static ArrayList<ArrayList<gm>> a(boolean paramBoolean)
  {
  ...
  public static void a(Context paramContext)
  {
    ...
    a = new gm.a(paramContext, null);
    gx.a(paramContext);
  }
  
  public static void a(gm.b paramb)
  {
    synchronized (c)
    {
      c.add(paramb);
  ...
  public static void b(gm.b paramb)
  {
    synchronized (c)
    {
      c.remove(paramb);
  ...
  public Drawable a(Context paramContext, Drawable paramDrawable)
  {
    try
    {
      if ((q == null) && (r != null))
      {
        Bitmap localBitmap = BitmapFactory.decodeByteArray(r, 0, r.length);
        q = new BitmapDrawable(paramContext.getResources(), localBitmap);
      }
      if (q != null) {
        paramDrawable = q;
      }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 105	aau:d	(Ljava/lang/String;)Z
    //   6: ifne +55 -> 61
    //   9: aload_0
    //   10: aload_1
    //   11: aload_0
    //   12: getfield 225	gm:g	Ljava/lang/String;
    //   15: invokestatic 110	com/android/mms/MmsApp:c	()Lcom/android/mms/MmsApp;
    //   18: invokevirtual 113	com/android/mms/MmsApp:h	()Ljava/lang/String;
    //   21: invokestatic 118	android/telephony/MzPhoneNumberUtilsExt:formatNumber	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   24: putfield 99	gm:f	Ljava/lang/String;
    //   27: aload_0
    //   28: aload_1
    //   29: invokestatic 110	com/android/mms/MmsApp:c	()Lcom/android/mms/MmsApp;
    //   32: invokevirtual 113	com/android/mms/MmsApp:h	()Ljava/lang/String;
    //   35: invokestatic 275	android/telephony/PhoneNumberUtils:formatNumberToE164	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   38: putfield 225	gm:g	Ljava/lang/String;
    //   41: aload_0
    //   42: aload_1
    //   43: invokestatic 278	wd:d	(Ljava/lang/String;)Ljava/lang/String;
    //   46: putfield 245	gm:k	Ljava/lang/String;
    //   49: aload_0
    //   50: invokespecial 239	gm:r	()V
    //   53: aload_0
    //   54: iconst_1
    //   55: putfield 182	gm:j	Z
    //   58: aload_0
    //   59: monitorexit
    //   60: return
    //   61: aload_0
    //   62: aload_1
    //   63: putfield 99	gm:f	Ljava/lang/String;
    //   66: goto -39 -> 27
    //   69: astore_1
    //   70: aload_0
    //   71: monitorexit
  ...
  public String g()
  {
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 178	gm:h	Ljava/lang/String;
    //   25: astore_1
    //   26: goto -9 -> 17
    //   29: astore_1
    //   30: aload_0
  ...
  public boolean k()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 88	gm:n	J
    //   6: lconst_0
    //   7: lcmp
    //   8: ifle +21 -> 29
    //   11: aload_0
    //   12: getfield 88	gm:n	J
    //   15: invokestatic 286	android/provider/MzContactsContract$MzNetContacts:isYPContact	(J)Z
    //   18: istore_1
    //   19: iload_1
    //   20: ifne +9 -> 29
    //   23: iconst_1
  ...
  public Uri m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 289	gm:k	()Z
    //   6: ifeq +18 -> 24
    //   9: getstatic 295	android/provider/ContactsContract$CommonDataKinds$Phone:CONTENT_URI	Landroid/net/Uri;
    //   12: aload_0
    //   13: getfield 176	gm:d	J
    //   16: invokestatic 301	android/content/ContentUris:withAppendedId	(Landroid/net/Uri;J)Landroid/net/Uri;
    //   19: astore_1
    //   20: aload_0
    //   21: monitorexit
    //   22: aload_1
    //   23: areturn
    //   24: new 303	android/net/Uri$Builder
    //   27: dup
    //   28: invokespecial 304	android/net/Uri$Builder:<init>	()V
    //   31: astore_1
    //   32: aload_1
    //   33: ldc_w 306
    //   36: invokevirtual 310	android/net/Uri$Builder:scheme	(Ljava/lang/String;)Landroid/net/Uri$Builder;
    //   39: pop
    //   40: aload_1
    //   41: aload_0
    //   42: getfield 99	gm:f	Ljava/lang/String;
    //   45: invokevirtual 313	android/net/Uri$Builder:encodedOpaquePart	(Ljava/lang/String;)Landroid/net/Uri$Builder;
    //   48: pop
    //   49: aload_1
    //   50: invokevirtual 316	android/net/Uri$Builder:build	()Landroid/net/Uri;
    //   53: astore_1
    //   54: goto -34 -> 20
    //   57: astore_1
    //   58: aload_0
  ...
  public String toString()
  {
    ...
    label149:
    label157:
    for (String str5 = m;; str5 = "null")
    {
      return String.format("{ number=%s, name=%s, mStandardNumber=%s ,nameAndNumber=%s, label=%s, person_id=%d, hash=%d method_id=%d }", new Object[] { str1, str2, str3, str4, str5, Long.valueOf(n), Integer.valueOf(hashCode()), Long.valueOf(d) });
      str1 = "null";
      break;
      str2 = "null";
      break label24;
