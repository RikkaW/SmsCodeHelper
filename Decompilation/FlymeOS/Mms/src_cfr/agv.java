...
extends PhoneStateListener {
    ...
    public void onCellLocationChanged(CellLocation cellLocation) {
        ...
        try {
            if (agu.a(this.a)) return;
            agu.a(this.a, cellLocation);
            agu.a(this.a, ahz.b());
            agu.b(this.a, ahz.b());
            return;
        }
     ...
     */
    public void onServiceStateChanged(ServiceState var1_1) {
     ...
     * Exception decompiling
     */
    public void onSignalStrengthChanged(int var1_1) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public void onSignalStrengthsChanged(SignalStrength var1_1) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: First case is not immediately after switch.
        // org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.SwitchReplacer.examineSwitchContiguity(SwitchReplacer.java:366)
        // org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.SwitchReplacer.replaceRawSwitches(SwitchReplacer.java:65)
