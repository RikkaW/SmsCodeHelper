...
class SlideNotice$SlideViewController
  implements SlideNoticeManagerService.NoticeCallBack
{
  ...
  public SlideNotice$SlideViewController(SlideNotice paramSlideNotice1, SlideNotice paramSlideNotice2)
  {
    mNoticeHandler = new SlideNotice.NoticeHandler(paramSlideNotice2);
    init();
  }
  ...
  private void init()
  {
    mSlideContent = LayoutInflater.from(SlideNotice.access$600(this$0)).inflate(R.layout.mc_slide_notice_content, null);
    ...
    mStatusBarHeight = getStatusBarHeight(SlideNotice.access$600(this$0));
    mActionBarHeight = getActionBarHeight(SlideNotice.access$600(this$0));
    mAnimationExecutor = new AnimationExecutor();
    Context localContext = SlideNotice.access$600(this$0).getApplicationContext();
    if (localContext != null) {}
    for (mWManager = ((WindowManager)localContext.getSystemService("window"));; mWManager = ((WindowManager)SlideNotice.access$600(this$0).getSystemService("window")))
    {
      mParams.height = -2;
      mParams.width = -1;
      mParams.gravity = 51;
      ...
      if (!(SlideNotice.access$600(this$0) instanceof Activity)) {
        mActionBarHeight = SlideNotice.access$600(this$0).getResources().getDimensionPixelSize(R.dimen.mz_action_bar_default_height);
      }
      return;
    }
  }
  ...
  {
    if (SlideNotice.access$600(this$0) != null) {
      packageName = SlideNotice.access$600(this$0).getPackageName();
    }
  ...
  private void prepareNotice(WindowManager.LayoutParams paramLayoutParams)
  {
    ...
    if (mSlideView == null)
    {
      localObject = new SlideNotice.SlideContainerView(SlideNotice.access$600(this$0));
      ((FrameLayout)localObject).addView(mSlideContent);
      mSlideView = ((View)localObject);
    }
    if ((SlideNotice.access$600(this$0) instanceof Activity))
    {
      localObject = ((Activity)SlideNotice.access$600(this$0)).getWindow().getDecorView().getWindowToken();
      if (localObject != null)
      {
  ...
  private void setupContent()
  {
    ...
    if (mIsOverlaidByStatusBar)
    {
      ...
      mNoticeView.getLayoutParams()).topMargin = SlideNotice.access$600(this$0).getResources().getDimensionPixelSize(R.dimen.mc_slide_notice_textview_margin_top);
    }
    for (;;)
    {
      if (mNoticeHeight > 0) {
  ...
  class AnimationExecutor
  {
    ...
    public void start(int paramInt1, int paramInt2)
    {
      ...
      anim = ObjectAnimator.ofInt(SlideNotice.access$1200(this$0), "height", new int[] { paramInt1, paramInt2 });
    ...
    implements Animator.AnimatorListener
  {
    ...
    public void onAnimationEnd(Animator paramAnimator)
    {
      ...
      SlideNotice.access$1200(this$0).destroy();
    }
    ...
    {
      SlideNotice.SlideViewController.access$1302(SlideNotice.access$1200(this$0), true);
    }
  }
}

/* Location:
 * Qualified Name:     com.meizu.common.app.SlideNotice.SlideViewController
