...
public abstract class PinnedHeaderArrayAdapter<T>
  extends MultiArrayPartitionAdapter<T>
  implements PinnedHeaderListView.PinnedHeaderAdapter
{
  ...
  public PinnedHeaderArrayAdapter(Context paramContext)
  {
    super(paramContext);
  }
  
  public PinnedHeaderArrayAdapter(Context paramContext, List<T>... paramVarArgs)
  {
...
/* Location:
 * Qualified Name:     com.meizu.common.widget.PinnedHeaderArrayAdapter
