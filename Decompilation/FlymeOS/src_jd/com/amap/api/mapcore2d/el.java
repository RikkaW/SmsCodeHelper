...
abstract class el
{
  ...
  protected el(Context paramContext)
  {
    ...
    {
      ed.a(paramContext, "LogProcessor", "LogUpDateProcessor");
      paramContext.printStackTrace();
    }
  }
  
  public static el a(Context paramContext, int paramInt)
  {
    switch (paramInt)
    {
    default: 
      return null;
    case 0: 
      return new eg(paramContext);
    case 1: 
      return new ei(paramContext);
    }
    return new ee(paramContext);
  }
  
  private ep a(Context paramContext, String paramString)
  {
    try
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(paramContext.getFilesDir().getAbsolutePath());
      localStringBuilder.append(ek.a);
      localStringBuilder.append(paramString);
      paramContext = new File(localStringBuilder.toString());
      if ((!paramContext.exists()) && (!paramContext.mkdirs())) {
        return null;
      }
      paramContext = ep.a(paramContext, 1, 1, 20480L);
      return paramContext;
    }
    catch (IOException paramContext)
    {
      ed.a(paramContext, "LogProcessor", "initDiskLru");
      paramContext.printStackTrace();
      return null;
    }
    catch (Throwable paramContext)
  ...
  private String a(List<dr> paramList, Context paramContext)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    {
      paramContext = (dr)paramList.next();
  ...
  private void a(dp paramdp, int paramInt)
  {
    try
    {
      a(paramdp.a(2, paramInt), paramdp, paramInt);
      return;
    }
    catch (Throwable paramdp)
    {
      ed.a(paramdp, "LogProcessor", "processDeleteFail");
      paramdp.printStackTrace();
    }
  }
  
  private void a(List<dr> paramList, dp paramdp, int paramInt)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        dr localdr = (dr)paramList.next();
        if (a(localdr.b()))
        {
          paramdp.a(localdr.b(), paramInt);
        }
        else
        {
          localdr.a(2);
          paramdp.a(localdr, localdr.a());
        }
      }
    }
  }
  ...
  private int b(String paramString)
  {
    ...
    paramString = new em(di.b(paramString.getBytes()));
    try
    {
      paramString = ex.a(false).a(paramString);
      if (paramString == null) {
        return 0;
      }
      ...
      {
        ed.a(paramString, "LogProcessor", "processUpdate");
        paramString.printStackTrace();
        return 0;
      }
      return 0;
    }
    catch (cz paramString)
    {
      ed.a(paramString, "LogProcessor", "processUpdate");
      paramString.printStackTrace();
    }
  ...
  private String c(Context paramContext)
  {
    try
    {
      String str = dc.a(paramContext);
      if ("".equals(str)) {
        return null;
      }
      paramContext = dc.b(paramContext, str.getBytes("UTF-8"));
      return paramContext;
    }
    catch (UnsupportedEncodingException paramContext)
    {
      ed.a(paramContext, "LogProcessor", "getPublicInfo");
      paramContext.printStackTrace();
      return null;
    }
    catch (Throwable paramContext)
  ...
  private String c(String paramString)
  {
    ...
    //   4: astore 8
    //   6: aload_0
    //   7: getfield 21	com/amap/api/mapcore2d/el:a	Lcom/amap/api/mapcore2d/ep;
    //   10: astore_3
    //   11: aload_3
    //   12: ifnonnull +34 -> 46
    //   15: iconst_0
    ...
    //   45: areturn
    //   46: aload_0
    //   47: getfield 21	com/amap/api/mapcore2d/el:a	Lcom/amap/api/mapcore2d/ep;
    //   50: aload_1
    //   51: invokevirtual 257	com/amap/api/mapcore2d/ep:a	(Ljava/lang/String;)Lcom/amap/api/mapcore2d/ep$b;
    //   54: astore_1
    //   55: aload_1
    //   56: ifnonnull +50 -> 106
    //   59: iconst_0
    ...
    //   89: ldc 23
    //   91: ldc_w 259
    //   94: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   97: aload 7
    //   99: astore_3
    //   100: aload_1
    ...
    //   106: aload_1
    //   107: iconst_0
    //   108: invokevirtual 264	com/amap/api/mapcore2d/ep$b:a	(I)Ljava/io/InputStream;
    //   111: astore_1
    ...
    //   180: ldc 23
    //   182: ldc_w 279
    //   185: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   188: aload 5
    //   190: astore 4
    //   192: aload_1
    //   193: astore_3
    ...
    //   225: ldc 23
    //   227: ldc_w 259
    //   230: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   233: aload 7
    //   235: astore_3
    //   236: goto -136 -> 100
    //   239: aload 5
    ...
    //   283: ldc 23
    //   285: ldc_w 259
    //   288: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   291: goto -191 -> 100
    //   294: astore 6
    //   296: aconst_null
    //   297: astore 5
    ...
    //   309: ldc 23
    //   311: ldc_w 279
    //   314: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   317: aload 5
    //   319: astore 4
    //   321: aload_1
    //   322: astore_3
    ...
    //   354: ldc 23
    //   356: ldc_w 259
    //   359: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   362: aload 7
    //   364: astore_3
    //   365: goto -265 -> 100
    //   368: astore 5
    ...
    //   398: ldc 23
    //   400: ldc_w 289
    //   403: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   406: aload_3
    ...
    //   415: ldc 23
    //   417: ldc_w 259
    //   420: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   423: aload_1
    ...
    //   432: ldc 23
    //   434: ldc_w 289
    //   437: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   440: aload_3
    ...
    //   449: ldc 23
    //   451: ldc_w 289
    //   454: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   457: aload_3
    ...
    //   466: ldc 23
    //   468: ldc_w 289
    //   471: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   474: aload_1
    ...
    //   483: ldc 23
    //   485: ldc_w 259
    //   488: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   491: aload 7
    //   493: astore_3
    //   494: goto -394 -> 100
    //   497: astore_1
    ...
    //   499: ldc 23
    //   501: ldc_w 289
    //   504: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   507: aload_1
    ...
    //   518: ldc 23
    //   520: ldc_w 289
    //   523: invokestatic 30	com/amap/api/mapcore2d/ed:a	(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   526: aload 4
  ...
  void b(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        localdp = new dp(paramContext);
        a(localdp, b());
        localList = localdp.a(0, b());
    ...
    {
      ed.a(paramContext, "LogProcessor", "processUpdateLog");
      paramContext.printStackTrace();
      return;
    }
  ...
  void c()
  {
    ...
    {
      ed.a(localIOException, "LogProcessor", "closeDiskLru");
      localIOException.printStackTrace();
      return;
    }
    catch (Throwable localThrowable)
    {
      ed.a(localThrowable, "LogProcessor", "closeDiskLru");
