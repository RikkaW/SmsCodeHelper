  ...
  public m a(m[] paramArrayOfm)
  {
    ...
    for (paramArrayOfm = ((n)localm2.b()).b();; paramArrayOfm = localm2)
    {
      ...
      for (;;)
      {
        ...
        if (Double.compare(localm1.i().doubleValue(), 0.0D) == 0) {
