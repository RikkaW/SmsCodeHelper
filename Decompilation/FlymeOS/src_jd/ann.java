  ...
  extends IInterface
{
    ...
    implements ann
  {
    ...
    public static ann a(IBinder paramIBinder)
    {
      if (paramIBinder == null) {
        return null;
      }
      IInterface localIInterface = paramIBinder.queryLocalInterface("com.meizu.voiceassistant.support.IVoiceAssistantCallback");
      if ((localIInterface != null) && ((localIInterface instanceof ann))) {
        return (ann)localIInterface;
      }
      return new ann.a.a(paramIBinder);
    }
    ...
    public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      case 1598968902: 
        paramParcel2.writeString("com.meizu.voiceassistant.support.IVoiceAssistantCallback");
        return true;
      case 1: 
        paramParcel1.enforceInterface("com.meizu.voiceassistant.support.IVoiceAssistantCallback");
